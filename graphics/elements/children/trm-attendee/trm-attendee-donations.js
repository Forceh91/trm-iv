...
class TRMAttendeeDonations extends Polymer.Element {
  static get is() {
  ...
  ready() {
    ...
    nodecg.listenFor(
      "donationGoalAchieved",
      this.showAchievedDonationGoal.bind(this)
    );
  ...
  showAchievedDonationGoal(goal) {
    ...
    const donationGoalAchievedElement = document.createElement(
      "trm-attendee-donation-goal-achieved"
    );
